...
__all__ = ["PanopticCenterTrack"]


@META_ARCH_REGISTRY.register()
class PanopticCenterTrack(nn.Module):
    """
    ...
    def __init__(self, cfg):
        ...
        self.size_divisibility = cfg.MODEL.CENTERTRACK.SIZE_DIVISIBILITY
        self.roi_heads = build_roi_heads(cfg, '', 'center_track')
        self.sem_seg_head = build_sem_seg_head(cfg, '', 'center_track')
        ...
        if mode == "panoptic":
            ...
            if "sem_seg" in batched_inputs[0]:
                ...
                gt_sem_seg = ImageList.from_tensors(
                    gt_sem_seg, self.size_divisibility, self.sem_seg_head.ignore_value
                ).tensor
            else:
                gt_sem_seg = None
